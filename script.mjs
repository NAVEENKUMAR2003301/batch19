...
// // // // // // // .then((jsData)=>{
// // // // // // //   console.log(jsData);
// // // // // // //  let higher5price =  jsData.find((c,i,t)=>{
// // // // // // //     return c.price <= 10
    
// // // // // // //   })
// // // // // // //   console.log(higher5price);
...
// // // // // // let class2 = document.querySelector(".one1")

// // // // // // console.log(class2);

// // // // // // let id2 = document.querySelector("#two2")

// // // // // // console.log(id2);

// // // // // // // querySelectorAll

// // // // // // let bundle = document.querySelectorAll(".three")
...
// // // // // console.log(parent.firstChild);// firstChild --> #text
// // // // // console.log(parent.firstElementChild);// firstElementChild --> element
// // // // // console.log(parent.lastChild);//lastChild
// // // // // console.log(parent.lastElementChild);//lastElementChild


// // // // // // siblings select method
...
// // // // // if you want manipulate input tag inside value to use (value)

// // // // // other tag inside value you want to manipulate to use (1. innerText, 2. innerHtml , 3. TextContent)
...
// // // // // button.innerText = eval(10 * 10 * (3 - 5) + 5 * 9 - 2);
...
//     custom.innerHTML = `<img src=${c.image} /><h1>${c.title.slice(0,25)}...</h1> <p>${c.description.slice(0,50)}...</p> <h3>price : ${c.price}<h3/>`;

//     api.appendChild(custom)
...
import { signInData } from "./signin.mjs";
